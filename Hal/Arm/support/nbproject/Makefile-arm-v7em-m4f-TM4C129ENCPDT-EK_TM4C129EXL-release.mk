...
${OBJECTDIR}/src/arm.o: src/arm.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../../Kernel/common/include -Iinclude -I../processor/Cortex-M/M4/TM4C129ENCPDT/include -I../architecture/v7/v7-M/ArchV7-M/include -I../architecture/v7/v7-M/PmsrV7-M/include -I../isa/Thumb/include -I../board/TI/EK-TM4C129EXL/include -I../../memory/MemoryAreaSingle/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/arm.o src/arm.c

${OBJECTDIR}/src/syscallStackSize.o: src/syscallStackSize.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../../Kernel/common/include -Iinclude -I../processor/Cortex-M/M4/TM4C129ENCPDT/include -I../architecture/v7/v7-M/ArchV7-M/include -I../architecture/v7/v7-M/PmsrV7-M/include -I../isa/Thumb/include -I../board/TI/EK-TM4C129EXL/include -I../../memory/MemoryAreaSingle/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/syscallStackSize.o src/syscallStackSize.c
