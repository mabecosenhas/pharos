...
const uint32_t pharosVCpuSyscallStackSize[PHAROS_SYSCALL_API_LAST_CALL + 1U] = {
    ...
    [PHAROS_SYSCALL_BULK_GET] = 8U ,
    [PHAROS_SYSCALL_BULK_GIVE] = 0U ,
    [PHAROS_SYSCALL_CHANNEL_SEND] = 4U ,
    [PHAROS_SYSCALL_CHANNEL_LOCAL_RECEIVE] = 16U ,
    [PHAROS_SYSCALL_CHANNEL_RECEIVE] = 16U ,
    ...
    [PHAROS_SYSCALL_LW_QUEUE_RECEIVE_TIMEOUT] = 8U ,
    [PHAROS_SYSCALL_HW_QUEUE_SEND] = 24U ,
    [PHAROS_SYSCALL_HW_QUEUE_RECEIVE] = 16U ,
    [PHAROS_SYSCALL_RESOURCE_ACCESS] = 16U ,
    ...
    [PHAROS_SYSCALL_TIMER_START] = 12U ,
    ...
    [PHAROS_SYSCALL_CRITICAL_SECTION_EXECUTE] = 8U ,
    [PHAROS_SYSCALL_IP_CALL] = 0U ,
    [PHAROS_SYSCALL_DEBUG_PRINT_CHAR] = 0U ,
    [PHAROS_SYSCALL_FUTURE_GET] = 0U ,
    [PHAROS_SYSCALL_FUTURE_FREE] = 0U ,
    [PHAROS_SYSCALL_FUTURE_WAIT] = 8U ,
    [PHAROS_SYSCALL_FUTURE_READY] = 0U ,
    [PHAROS_SYSCALL_FUTURE_QUEUE_ADD] = 0U ,
    [PHAROS_SYSCALL_FUTURE_QUEUE_REMOVE] = 0U ,
    [PHAROS_SYSCALL_FUTURE_QUEUE_WAIT] = 8U ,
    [PHAROS_SYSCALL_MALLOC] = 0U ,
    [PHAROS_SYSCALL_FREE] = 0U ,
    [PHAROS_SYSCALL_THREAD_APERIODIC_CREATE] = 0U ,
    [PHAROS_SYSCALL_THREAD_PERIODIC_CREATE] = 0U ,
    [PHAROS_SYSCALL_THREAD_SPORADIC_CREATE] = 0U ,
    [PHAROS_SYSCALL_THREAD_START] = 0U ,
    [PHAROS_SYSCALL_THREAD_START_DELAY] = 0U ,
    [PHAROS_SYSCALL_THREAD_GET_ID_SELF] = 0U ,
    [PHAROS_SYSCALL_THREAD_GET_ID] = 0U ,
    [PHAROS_SYSCALL_THREAD_GET_STATUS] = 0U ,
    [PHAROS_SYSCALL_THREAD_SET_PRIORITY] = 0U ,
    [PHAROS_SYSCALL_THREAD_STOP] = 0U ,
    [PHAROS_SYSCALL_THREAD_STOP_SELF] = 0U ,
    [PHAROS_SYSCALL_THREAD_RESTART] = 0U ,    
    [PHAROS_SYSCALL_THREAD_STACK] = 4U ,    
};
