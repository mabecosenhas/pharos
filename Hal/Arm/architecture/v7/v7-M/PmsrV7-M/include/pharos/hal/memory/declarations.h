...
#ifndef PHAROS_PMSRV7M_DECLARATIONS_H
#define PHAROS_PMSRV7M_DECLARATIONS_H
...
/**
 * Alignment of the a dynamically created stack. Must be aligned be the size of the stack
 */
#define PHAROS_DYNAMIC_STACK_ALIGN(size)            PHAROS_SHARED_STACK_CORRECT_SIZE(size)
 

/* PHAROS_PMSRV7M_DECLARATIONS_H */
#endif 
