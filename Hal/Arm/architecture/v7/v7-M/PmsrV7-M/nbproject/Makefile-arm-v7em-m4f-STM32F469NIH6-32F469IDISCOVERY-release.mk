...
${OBJECTDIR}/src/mpu.o: src/mpu.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Iinclude -I../../../../../../Kernel/common/include -I../../../../support/include -I../../../../processor/Cortex-M/M4/M4/include -I../ArchV7-M/include -I../../../../isa/Thumb/include -I../../../../../../Kernel/rsp/include -I../../../../processor/Cortex-M/M4/STM32F469NIH6/include -I../../../../board/ST/DISCOVERY/32F469I/include -I../../../../../memory/MemoryAreaMultiple/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mpu.o src/mpu.c
