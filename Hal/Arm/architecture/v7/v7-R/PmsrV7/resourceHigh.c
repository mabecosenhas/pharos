...
uint64_t pharosCpuResourceExecuteAccessLow(void *data , uint64_t input , ResourceAccessMethod method , ptrPartitionCpuMmuContext context , StackPointer sharedStack);
