...
${OBJECTDIR}/_ext/7cc14b06/mmu.o: ../../../architecture/v5/Mmuv5/src/mmu.S
	...
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/_ext/7cc14b06/mmu.o ../../../architecture/v5/Mmuv5/src/mmu.S
...
${OBJECTDIR}/_ext/e71745e7/handlerDataAbort.o: ../../../processor/ARM9/arm926ej-s/src/handlerDataAbort.S
	...
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/_ext/e71745e7/handlerDataAbort.o ../../../processor/ARM9/arm926ej-s/src/handlerDataAbort.S

${OBJECTDIR}/src/channel.o: src/channel.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/channel.o src/channel.S

${OBJECTDIR}/src/criticalSection.o: src/criticalSection.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/criticalSection.o src/criticalSection.S

${OBJECTDIR}/src/div.o: src/div.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/div.o src/div.S

${OBJECTDIR}/src/handlerSwi.o: src/handlerSwi.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/handlerSwi.o src/handlerSwi.S

${OBJECTDIR}/src/hwqueue.o: src/hwqueue.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/hwqueue.o src/hwqueue.S

${OBJECTDIR}/src/ipcall.o: src/ipcall.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/ipcall.o src/ipcall.S
...
${OBJECTDIR}/src/resource.o: src/resource.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/resource.o src/resource.S

${OBJECTDIR}/src/start.o: src/start.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/start.o src/start.S

${OBJECTDIR}/src/userMode.o: src/userMode.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/userMode.o src/userMode.S
