...
${OBJECTDIR}/src/interpartition.o: src/interpartition.S
	...
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/interpartition.o src/interpartition.S

${OBJECTDIR}/src/interpartitionhigh.o: src/interpartitionhigh.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -I../../../board/Qemu/Versatilepb/include -I../../../processor/ARM9/arm926ej-s/include -I../../../../../Kernel/common/include -I../../../architecture/v5/Mmuv5/include -I../../../support/include -I../../../../memory/MemoryAreaSingle/include -I../../../processor/support/PrimeCell/ArmVicPl190/include -I../../../../../Kernel/rsp/include -I../../../isa/Arm/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/interpartitionhigh.o src/interpartitionhigh.c

${OBJECTDIR}/src/interruptstack.o: src/interruptstack.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -I../../../board/Qemu/Versatilepb/include -I../../../processor/ARM9/arm926ej-s/include -I../../../../../Kernel/common/include -I../../../architecture/v5/Mmuv5/include -I../../../support/include -I../../../../memory/MemoryAreaSingle/include -I../../../processor/support/PrimeCell/ArmVicPl190/include -I../../../../../Kernel/rsp/include -I../../../isa/Arm/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/interruptstack.o src/interruptstack.c

${OBJECTDIR}/src/isrhandlerV5.o: src/isrhandlerV5.S
	${MKDIR} -p ${OBJECTDIR}/src
	$(AS) $(ASFLAGS) -o ${OBJECTDIR}/src/isrhandlerV5.o src/isrhandlerV5.S
