...
${OBJECTDIR}/src/io.o: src/io.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Iinclude -I../../processor/Cortex-R/R5/tms570lc4357/include -I../../processor/Cortex-R/R5/R5/include -I../../architecture/v7/v7-R/ArchV7-R/include -I../../architecture/v7/v7-R/PmsrV7/include -I../../../../Kernel/common/include -I../../support/include -I../../manufacturer/ti/Vim/include -I../../../memory/MemoryAreaSingle/include -I../../board/TI/LaunchXL2-570LC43/include -I../../../../Kernel/rsp/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/io.o src/io.c
