...
${OBJECTDIR}/src/io.o: src/io.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Werror -Iinclude -I../../../../Kernel/common/include -I../../support/include -I../../architecture/v7/v7-M/ArchV7-M/include -I../../processor/Cortex-M/M4/M4/include -I../../architecture/v7/v7-M/PmsrV7-M/include -I../../processor/Cortex-M/M4/STM32F469NIH6/include -I../../../memory/MemoryAreaMultiple/include -I../../board/ST/DISCOVERY/32F469I/include -I../../../../Kernel/rsp/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/io.o src/io.c
