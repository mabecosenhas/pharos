...
{
    /* make sure the compiler has issued all memory related operations and will not optimize memory accesses */
...
{
    /* make sure the compiler has issued all memory related operations before enabling interrupts */
    PHAROS_SW_MEMORY_BARRIER();
